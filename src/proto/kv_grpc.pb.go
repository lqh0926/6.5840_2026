...
const (
	...
	KV_Append_FullMethodName = "/proto.KV/Append"
)
...
type KVClient interface {
	...
	Append(ctx context.Context, in *AppendArgs, opts ...grpc.CallOption) (*AppendReply, error)
}
...
func (c *kVClient) Append(ctx context.Context, in *AppendArgs, opts ...grpc.CallOption) (*AppendReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AppendReply)
...
type KVServer interface {
	...
	Append(context.Context, *AppendArgs) (*AppendReply, error)
...
func (UnimplementedKVServer) Append(context.Context, *AppendArgs) (*AppendReply, error) {
...
func _KV_Append_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KVServer).Append(ctx, req.(*AppendArgs))
	}
	return interceptor(ctx, in, info, handler)
}
